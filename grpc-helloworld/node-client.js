...
//var client = new helloworld.Greeter('localhost:9090', grpc.credentials.createInsecure());
var client = new helloworld.Greeter('192.168.99.100:9090', grpc.credentials.createInsecure());
//var client = new helloworld.Greeter('127.0.0.1:9090', grpc.credentials.createInsecure());
